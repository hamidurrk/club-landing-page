  ...
  return (
    <>
      <div className="bg-background ">
        <Navbar />        
        <section className="wrap-md wrap-px mx-auto px-12 pt-4 xl:w-4/5">
          <div className="h-screen">
            <div className="mt-12 grid h-3/4 grid-cols-6 gap-5">
              <div className="col-span-6 row-span-2 lg:col-span-4">
                <div className="relative flex aspect-auto h-full content-center items-center gap-4 overflow-hidden rounded-xl bg-bento p-8 shadow-sm sm:p-12 ">
                  <div className="content relative z-10 flex max-w-full flex-wrap gap-4 sm:max-w-72 md:max-w-96">
                    <h2 className="mb-0 text-3xl font-bold sm:text-3xl md:text-4xl">
                      <text className="text-primary">Stanford</text>'s Premiere
                      Artificial Inelligence Club
                    </h2>
                    <p>
                  ...
                  <div className="image-container absolute inset-y-0 right-0 z-10 hidden w-40 max-w-64 p-5 sm:flex md:w-52 md:max-w-48 lg:max-w-52">
                    <img
                      src="/logo.png"
                      alt="Alt text"
                  ...
                  <span className="absolute inset-y-0 left-32 block w-full sm:left-52 md:left-[200px]">
                    <span className="absolute block h-full w-full bg-gradient-to-r from-transparent to-background"></span>
                    <span className="block h-full w-full bg-contain sm:bg-cover"></span>
                  </span>
                </div>
              </div>
              <div className="col-span-6 row-span-1 sm:col-span-3 lg:col-span-2">
                <div className="from-primary-200 via-primary-400 to-primary-600 relative flex h-full flex-wrap content-start overflow-hidden rounded-xl bg-bento bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] px-4 pt-8 shadow-sm md:aspect-auto">
                  <div className="relative flex h-full w-full items-center justify-center">
                    <div className="content relative z-10 flex flex-wrap content-center justify-center gap-1 text-white md:max-w-64">
                      <h2 className="mb-0 w-full text-center text-xl font-bold sm:text-3xl md:text-xl">
                        Some title for the club
                      </h2>
                      <p>Some other part</p>
                    </div>
                    <div className="image-container absolute bottom-0 flex">
              ...
              <div className="col-span-6 row-span-1 sm:col-span-3 lg:col-span-2">
                <div className="relative flex h-full flex-wrap content-center gap-4 overflow-hidden rounded-xl bg-accent p-8 shadow-sm sm:p-12 md:aspect-auto md:content-start">
                  ...
                  {/* <span className="block absolute inset-0 w-full h-full">
                            <span className="bg-gradient-to-t absolute from-accent from-40% to-transparent block w-full h-full"></span>
          ...
          <div className="-translate-y-16 transform px-6 lg:px-8">
      ...
      <HorizontalGallery />
          ...
          <div className="grid grid-cols-6 gap-4">
            <div className="col-span-6 sm:col-span-3 lg:col-span-2">
              <div className="relative flex h-full flex-wrap content-start gap-4 rounded-xl bg-bento p-8 sm:p-12">
                <div className="grid gap-12">
                  <a
                    className="hover:text-primary-500 flex items-center text-2xl font-black text-primary transition duration-500"
                    href="/"
                  >
                    {/* <svg
                      id="logo-81"
            ...
            <div className="col-span-6 sm:col-span-3 lg:col-span-4">
              <div className="relative flex h-full flex-wrap content-start gap-4 rounded-xl   bg-bento p-8 sm:p-12">
                <div className="content flex h-full w-full flex-wrap content-end">
            ...
            <div className="col-span-6">
              <div className="relative flex aspect-video flex-wrap content-start gap-4 overflow-hidden rounded-xl   bg-bento p-8 shadow-sm sm:p-12 md:aspect-[3/1]">
                <div className="image-container from-primary-400 via-primary-800 to-primary-200 absolute inset-y-0 bottom-0 right-0 flex h-full w-full flex-1 items-center bg-[conic-gradient(at_bottom_left,_var(--tw-gradient-stops))]">
                  <span className="bg-pattern one block"></span>
                </div>
              </div>
            </div>
          </div>
          <div className="px-6 lg:px-8 mt-12 mb-12">
            <div className="mx-auto max-w-2xl sm:text-center">
              <h2 className="text-4xl font-bold text-primary sm:text-5xl">
                Work
              </h2>
          ...
          <div className="grid grid-cols-6 gap-4 mt-12">
            <div className="col-span-6">
              <div className="relative flex flex-wrap content-start gap-4 overflow-hidden rounded-xl   bg-bento p-8 shadow-sm sm:aspect-square sm:p-12 md:aspect-auto lg:aspect-[3/1]">
                <div className="image-container flex h-full w-full flex-1 items-center">
                  <div className="relative z-10 flex max-w-[512px] flex-wrap gap-8">
                    <span className="block text-xl font-bold sm:text-3xl">
                      Looking for an awesome group of people to work with.
                    </span>
                    <a
                      href="#"
                      className="text-primary-500 block text-xl font-bold underline-offset-4 hover:underline hover:decoration-wavy sm:text-3xl hover:text-primary"
                    >
                      Join Now!
                    </a>
                  </div>
                  <div className="absolute inset-y-0 left-40 right-0 flex h-full w-full max-w-96 sm:left-auto">
                    <span className="absolute block h-full w-full bg-gradient-to-r from-transparent to-accent"></span>
                    <span className="bg-pattern one block w-full bg-contain object-contain"></span>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-span-6 sm:col-span-2">
              <Link
                href="#"
                className="bg-primary-500 hover:bg-primary-800 relative flex flex-wrap content-start gap-4 overflow-hidden rounded-xl border border-neutral-400/30 px-12 py-4 shadow-sm transition-colors duration-300"
              >
            ...
            <div className="col-span-6 sm:col-span-2">
              <Link
                href="#"
                className="hover:bg-primary-800 relative flex flex-wrap content-start gap-4 overflow-hidden rounded-xl bg-bento px-12 py-4  shadow-sm transition-colors duration-300 hover:text-white"
              >
...
{/*         
        <MaxWidthWrapper className="mt-10 flex flex-col items-center justify-center text-center sm:mt-12">
          <h1 className="max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl">
            <span className="text-blue-600">Stanford's</span> Premiere
            Artificial Inelligence Club
          </h1>
